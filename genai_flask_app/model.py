...
class AIResponse(BaseModel): 
    summary: str = Field(description="Resumo da mensagem do usuário") 
    sentiment: int = Field(description="Pontuação de sentimento de 0 (negativo) a 100 (positivo)") 
    category: str = Field(description="Categoria da consulta (por exemplo, cobrança, técnico, geral)") 
    action: str = Field(description="Ação recomendada para o representante de suporte")
